...
###########################################################################################
# NebulaKernel Build Script (C) 2016   UpDated: 09/14/2016                                #
...
# Cleaned up Code                                                                         #
# Added: TimeStamp Version now added to defconfig LOCAL_VERSION                           #
#                                                                                         #
#                                                                                         #
#                                                                                         #
#                                                                                         #
...
options=(1 "KERNEL_DIR: ${KERNEL_DIR}"
		 ...
		 6 "RAMDISK_NEBULA_DIR: ${RAMDISK_NEBULA_DIR}"
